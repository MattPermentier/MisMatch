...
let PluginMetaFields = () => {
	...
	return (
		<div style={{display: 'flex', flexDirection: 'column', textAlign: 'center'}}>
			...
			<hr/>
			<button onClick={() => { pasContrastAan() }}>Pas Contrast Aan</button>
...
// Fetch request naar wordpress api
function wp_ajax(action, args) {
...
// Voor wanneer je op de contrast-knop klikt
function pasContrastAan() {
	wp_ajax("missmatch", []);
	wp_ajax("get_suggestions", [])
